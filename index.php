    ...
    <body>
        <div class="content">
            <header>
                ...
                <div class="top" id="home"><h1><span class="title">Serviços de jardinagem</span></h1></div>


                <div id="jssor_1" class="slide" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
                    <!-- Loading Screen -->
                        ...
                        <div class="form">
                            <article>
                                <header>
                                    ...
                                    if (isset($nome) && isset($email) && isset($mensagem) && isset($telefone)):
                                        ...
                                        $mail->Username = "envio.ibratec@ibratecgrafica.com.br";
                                        //Password to use for SMTP authentication
                                        $mail->Password = "";
                                        //Set who the message is to be sent from
                                        $mail->setFrom('envio.ibratec@ibratecgrafica.com.br', 'First Last');
                                        //Set an alternative reply-to address
//                                        $mail->addReplyTo('replyto@example.com', 'First Last');
                                        //Set who the message is to be sent to
                                        $mail->addAddress('renetf77@gmail.com', 'John Doe');
